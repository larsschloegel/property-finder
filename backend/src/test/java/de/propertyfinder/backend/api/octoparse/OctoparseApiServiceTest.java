...
class OctoparseApiServiceTest {
    ...
    void mapToOctoparseApiDtoTest() throws JsonProcessingException {
        ...
        List<OctoparseApiDto> expected = List.of(
                new OctoparseApiDto("ansprechpartnerimpressum", "address", null,null,"ansprechpartner", "title", "Image1", "typ", "kaufpreis", "wohnflaeche", "anzahlZimmer",
    ...
    void filterOctparseApiDataTest()  {
        //Given
        List<OctoparseApiDto> octoparseApiDtoList = List.of(new OctoparseApiDto("", "08112 Wilkau-Haßlau, Zwickau (Kreis)","","", "", "", "", "\n        Villa\n        \n      ", "\n          \n            \n            315.000 €\n          \n        ", "\n                220,23  m²\n            ", "\n                10\n            ",
                        "\n        \n          Objekt-Nr.: WHPO |\n        \n        Scout-ID: 126237570\n      ", "", "\n                    157  m²\n                    \n                    \n                    \n                ", "\n                760  m²\n            "));
        //When
        OctoparseApiService octoparseApiService = new OctoparseApiService(accessTokenUtil, apiConnectionUtil);
        ...
        //Then
        List<OctoparseApiDto> expected = List.of(
                new OctoparseApiDto("", "08112 Wilkau-Haßlau, Zwickau (Kreis)","08112","Wilkau-Haßlau", "", "", "", "Villa", "315000", "220.23", "10",
                        "126237570", "", "157", "760")
        );
        assertThat(actual, is(expected));
    }
